...
## Corpus Check
- 170 files · ~122,570 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 475 nodes · 535 edges · 62 communities (37 shown, 25 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 8 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4f890105`
...
2. `OllamaServerController` - 23 edges
3. `Main` - 23 edges
4. `Лист просмотра ответов персонажа` - 21 edges
5. `LocalLlmResponder` - 19 edges
6. `Лист просмотра ответов персонажа` - 19 edges
7. `DialogueSmoke` - 13 edges
8. `What You Must Do When Invoked` - 12 edges
9. `LocalLlmRuntime` - 11 edges
...
## Knowledge Gaps
- **170 isolated node(s):** `Comments`, `Условия прогона`, `Ход 1`, `Ход 2`, `Ход 3` (+165 more)
...
- **What connects `Comments`, `Условия прогона`, `Ход 1` to the rest of the system?**
